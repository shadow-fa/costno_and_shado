...
// Zubr
_zub = "hgun_Pistol_heavy_02_F";
_zubmag = "6Rnd_45ACP_Cylinder";
...
// Marksman rifle
_DMrifle = "srifle_LRR_F";
_DMriflemag = "7Rnd_408_Mag";
...
// Ghillie
_ghillieUniform = ["U_Marshal"]; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = ["H_Cap_police"];
