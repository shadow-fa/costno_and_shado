...
// Default setup
_attachments = [_attach1, _silencer2]; // The default attachment set for most units, overwritten in the individual unitType
...
_standardRig = ["V_PlateCarrier1_blk"];
...
_pilotRig = ["V_PlateCarrierIAGL_oli","V_PlateCarrierIAGL_dgtl"];
_pilotGlasses = [];
