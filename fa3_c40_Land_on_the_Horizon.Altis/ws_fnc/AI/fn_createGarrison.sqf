...
7. Radius of area to be ignored (should be smaller than 2.)									 					 | OPTIONAL - int - default is 0
...
_radius_bl = if (count _this > 6) then {_this select 6} else {0};
